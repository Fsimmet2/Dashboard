...
include_once $this->targetDirs[2].'/vendor/symfony/security/Http/Authentication/AuthenticationSuccessHandlerInterface.php';
include_once $this->targetDirs[2].'/vendor/symfony/security/Http/Util/TargetPathTrait.php';
include_once $this->targetDirs[2].'/vendor/symfony/security/Http/Authentication/DefaultAuthenticationSuccessHandler.php';
include_once $this->targetDirs[2].'/vendor/symfony/security/Http/Authentication/AuthenticationFailureHandlerInterface.php';
include_once $this->targetDirs[2].'/vendor/symfony/security/Http/Authentication/DefaultAuthenticationFailureHandler.php';
include_once $this->targetDirs[2].'/vendor/symfony/security/Http/Firewall/ListenerInterface.php';
include_once $this->targetDirs[2].'/vendor/symfony/security/Http/Firewall/AbstractAuthenticationListener.php';
include_once $this->targetDirs[2].'/vendor/symfony/security/Http/Firewall/UsernamePasswordFormAuthenticationListener.php';
