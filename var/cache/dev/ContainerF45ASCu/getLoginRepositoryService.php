...
// Returns the private 'App\Repository\LoginRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/LoginRepository.php';

return $this->privates['App\Repository\LoginRepository'] = new \App\Repository\LoginRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
