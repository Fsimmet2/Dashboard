...
$a->setNamespace('sf_orm_default_40fb5e550dd718c8c23b34919b3bf187174bdbf460eaa65f5914df79b71f1dfa');

$b = new \Doctrine\Common\Cache\ArrayCache();
$b->setNamespace('sf_orm_default_40fb5e550dd718c8c23b34919b3bf187174bdbf460eaa65f5914df79b71f1dfa');

$c = new \Doctrine\Common\Cache\ArrayCache();
$c->setNamespace('sf_orm_default_40fb5e550dd718c8c23b34919b3bf187174bdbf460eaa65f5914df79b71f1dfa');
...
$e->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\LoginRepository' => function () {
    return ($this->privates['App\Repository\LoginRepository'] ?? $this->load(__DIR__.'/getLoginRepositoryService.php'));
}))));
